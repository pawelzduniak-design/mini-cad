...
FACE_HOVER = (1.0, 0.78, 0.22)
FACE_SELECTED = (1.0, 0.55, 0.16)
PREVIEW_BLUE = (0.20, 0.60, 1.0)
DIMENSION_LABEL = (0.94, 0.96, 1.0)
SKETCH_PROFILE = (0.0, 0.82, 0.76)
SKETCH_UNDER_DEFINED = SKETCH_PROFILE
SKETCH_FULLY_DEFINED = (0.18, 0.86, 0.36)
SKETCH_PROFILE_SELECTED = (0.95, 0.28, 0.82)
SKETCH_PREVIEW = (0.0, 0.95, 1.0)
SKETCH_ENTITY = (0.36, 0.95, 0.88)
TOOLTIP_BG = "#151b22"
